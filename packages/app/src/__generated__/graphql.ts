...
export type SwitchSessionMutationVariables = Exact<{
  input: SwitchToSessionInput;
}>;


export type SwitchSessionMutation = { __typename?: 'Mutation', switchToSession: { __typename?: 'SwitchToSessionPayload', currentSessionIndex: number } };
...
export type NotesRouteNoteCreatedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type NotesRouteNoteCreatedSubscription = { __typename?: 'Subscription', noteCreated: { __typename?: 'NoteCreatedPayload', note: { __typename?: 'Note', id: string | number, title: string, textContent: string } } };

export type NotesRouteNoteUpdatedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type NotesRouteNoteUpdatedSubscription = { __typename?: 'Subscription', noteUpdated: { __typename?: 'NoteUpdatedPayload', id: string | number, patch: { __typename?: 'NotePatch', title?: string | null, textContent?: string | null } } };

export type NotesRouteNoteDeletedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type NotesRouteNoteDeletedSubscription = { __typename?: 'Subscription', noteDeleted: { __typename?: 'NoteDeletedPayload', id: string | number } };
...
export type EditNoteDialogRouteUpdateNoteFragment = { __typename?: 'Note', title: string, textContent: string } & { ' $fragmentName'?: 'EditNoteDialogRouteUpdateNoteFragment' };

export const EditNoteDialogRouteUpdateNoteFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"EditNoteDialogRouteUpdateNote"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Note"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"textContent"}}]}}]} as unknown as DocumentNode<EditNoteDialogRouteUpdateNoteFragment, unknown>;
...
export const SwitchSessionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SwitchSession"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SwitchToSessionInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"switchToSession"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"currentSessionIndex"}}]}}]}}]} as unknown as DocumentNode<SwitchSessionMutation, SwitchSessionMutationVariables>;
...
export const NotesRouteNoteCreatedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"NotesRouteNoteCreated"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"noteCreated"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"note"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"textContent"}}]}}]}}]}}]} as unknown as DocumentNode<NotesRouteNoteCreatedSubscription, NotesRouteNoteCreatedSubscriptionVariables>;
export const NotesRouteNoteUpdatedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"NotesRouteNoteUpdated"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"noteUpdated"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"patch"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"textContent"}}]}}]}}]}}]} as unknown as DocumentNode<NotesRouteNoteUpdatedSubscription, NotesRouteNoteUpdatedSubscriptionVariables>;
export const NotesRouteNoteDeletedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"NotesRouteNoteDeleted"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"noteDeleted"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<NotesRouteNoteDeletedSubscription, NotesRouteNoteDeletedSubscriptionVariables>;
