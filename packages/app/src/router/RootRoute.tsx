...
import SnackbarErrorBoundary from '../feedback/SnackbarErrorBoundary';
import useIsMobile from '../hooks/useIsMobile';
import NotesMain from '../notes/NotesMain';

import { useProxyTransform } from './ProxyRoutesProvider';
...
function ModalRoutes() {
  return (
    <Routes>{/* <Route path="note/:id" element={<EditNoteDialogRoute />} /> */}</Routes>
  );
}
