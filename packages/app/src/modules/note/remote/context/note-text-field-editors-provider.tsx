...
import { useHTMLInputCollabEditor } from '../../../collab/hooks/use-html-input-collab-editor';

import { useSetFocusedEditor, FocusedEditorProvider } from './focused-editor-provider';
...
export function NoteTextFieldEditorsProvider({
  editors,
  children,
