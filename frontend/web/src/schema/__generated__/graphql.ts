...
export type PreferencesQuery = {
  __typename?: 'Query';
  preferences?: { __typename?: 'Preferences'; colorMode?: ColorMode | null } | null;
};
...
export type UpdateColorModeMutation = {
  __typename?: 'Mutation';
  updateColorMode: boolean;
};
...
export type CreateLocalSessionMutation = {
  __typename?: 'Mutation';
  createLocalSession: number;
};
...
export type CreateRemoteSessionMutation = {
  __typename?: 'Mutation';
  createRemoteSession: number;
};
...
export type DeleteClientSessionMutation = {
  __typename?: 'Mutation';
  deleteClientSession: boolean;
};
...
export type SessionQueryQuery = {
  __typename?: 'Query';
  activeClientSessionIndex: number;
  clientSessions: Array<
    | { __typename: 'LocalSession'; id: string; displayName: string }
    | {
        __typename: 'RemoteSession';
        cookieIndex: number;
        displayName: string;
...
export type SwitchToClientSessionMutation = {
  __typename?: 'Mutation';
  switchToClientSession: boolean;
};
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [{ kind: 'Field', name: { kind: 'Name', value: 'colorMode' } }],
            },
          },
        ],
      },
      ...
      variableDefinitions: [
        {
          ...
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'colorMode' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'ColorMode' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'colorMode' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'colorMode' } },
              },
            ],
            directives: [{ kind: 'Directive', name: { kind: 'Name', value: 'client' } }],
          },
...
} as unknown as DocumentNode<UpdateColorModeMutation, UpdateColorModeMutationVariables>;
        ...
        selections: [
          {
            ...
            directives: [{ kind: 'Directive', name: { kind: 'Name', value: 'session' } }],
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
...
export const OnNoteCreatedDocument = {
  ...
  OnNoteCreatedSubscription,
  OnNoteCreatedSubscriptionVariables
>;
  ...
  definitions: [
    {
      ...
      selectionSet: {
        kind: 'SelectionSet',
        selections: [{ kind: 'Field', name: { kind: 'Name', value: 'noteDeleted' } }],
      },
    },
  ],
} as unknown as DocumentNode<
  OnNoteDeletedSubscription,
  OnNoteDeletedSubscriptionVariables
>;
export const OnNoteUpdatedDocument = {
  ...
  OnNoteUpdatedSubscription,
  OnNoteUpdatedSubscriptionVariables
>;
...
export const CreateLocalSessionDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CreateLocalSession' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
  ...
  CreateLocalSessionMutation,
  CreateLocalSessionMutationVariables
>;
export const CreateRemoteSessionDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CreateRemoteSession' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'RemoteSessionInput' },
            },
          },
        },
      ],
  ...
  CreateRemoteSessionMutation,
  CreateRemoteSessionMutationVariables
>;
export const DeleteClientSessionDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'DeleteClientSession' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'clientSessions' },
            directives: [{ kind: 'Directive', name: { kind: 'Name', value: 'client' } }],
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: '__typename' } },
                {
                  ...
                  typeCondition: {
                    kind: 'NamedType',
                    name: { kind: 'Name', value: 'LocalSession' },
                  },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                ...
                },
                {
                  ...
                  typeCondition: {
                    kind: 'NamedType',
                    name: { kind: 'Name', value: 'RemoteSession' },
                  },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'cookieIndex' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'displayName' } },
          ...
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'activeClientSessionIndex' },
            directives: [{ kind: 'Directive', name: { kind: 'Name', value: 'client' } }],
          },
        ],
      },
...
export const SwitchToClientSessionDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'SwitchToClientSession' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'index' } },
  ...
  SwitchToClientSessionMutation,
  SwitchToClientSessionMutationVariables
>;
