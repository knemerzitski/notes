...
import { useLocationPrefix } from '../../router/context/location-prefix-provider';
import { ProxyRoutesProvider } from '../../router/context/proxy-routes-provider';
...
export function useNavigateSwitchCurrentUser() {
