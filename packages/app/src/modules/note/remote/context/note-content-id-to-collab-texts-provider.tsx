...
import { getCollabEditor } from '../../../collab/hooks/use-collab-editor';

import { NoteContentIdProvider } from './note-content-id-provider';
import { NoteTextFieldEditorsProvider } from './note-text-field-editors-provider';
...
export function NoteContentIdToCollabTextsProvider({
  noteContentId,
