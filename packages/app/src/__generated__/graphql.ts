...
export type DeleteNoteUpdateNotesConnectionQueryVariables = Exact<{ [key: string]: never; }>;


export type DeleteNoteUpdateNotesConnectionQuery = { __typename?: 'Query', notesConnection: { __typename?: 'NoteConnection', notes: Array<{ __typename?: 'Note', id: string | number, title: string, textContent: string }> } };
...
export const DeleteNoteUpdateNotesConnectionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"DeleteNoteUpdateNotesConnection"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"notesConnection"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"notes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"textContent"}}]}}]}}]}}]} as unknown as DocumentNode<DeleteNoteUpdateNotesConnectionQuery, DeleteNoteUpdateNotesConnectionQueryVariables>;
